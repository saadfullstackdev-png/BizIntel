var FormControls = function () {
    ...
    var loadReport = function () {
        ...
        $.ajax({
            ...
            url: route('admin.reports.HR_report_load'),
            type: "POST",
            data: {
                ...
                user_id: $('#user_id').val(),
                application_user_id: $('#application_user_id').val(),
    ...
    var printReport = function (medium_type) {
        ...
        $('#search_type-report').val($('#search_type').val());
        $('#user_id-report').val($('#user_id').val());
        $('#application_user_id-report').val($('#application_user_id').val());
        $('#practitioner_id-report').val($('#practitioner_id').val());
