        ...
        if (service_id && patient_id) {
            $.ajax({
                ...
                success: function (resposne) {
                    ...
                    // $("#subscription_discount").prop("disabled", true);
                    if (resposne.status) {
            ...
            $.ajax({
                ...
                success: function (resposne) {
                    if (resposne.status == '1') {
                        ...
                        /*We enable add button after all functionality perform*/
