        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_packageAdvances', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_packageAdvances') )
                },
                ...
                ajax: {
                    ...
                    url: route('admin.packagesadvances.datatable'),
