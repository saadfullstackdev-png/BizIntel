        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_resources', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_resources') )
                },
                ...
                "columns": [
                    ...
                    {"data": "resource_types", "bSortable": false},
                    {"data": "location", "bSortable": false},
                    {"data": "machine_type", "bSortable": false},
                ...
                ajax: {
                    ...
                    url: route('admin.resources.datatable'),
