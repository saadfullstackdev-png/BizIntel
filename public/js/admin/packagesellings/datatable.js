        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function (settings, data) {
                    localStorage.setItem('DataTables_packagesellings', JSON.stringify(data))
                },
                stateLoadCallback: function (settings) {
                    return JSON.parse(localStorage.getItem('DataTables_packagesellings'))
                },
                ...
                "columns": [
                    ...
                    {"data": "total_services", "bSortable": false},
                    {"data": "tax_including_price", "bSortable": false},
                    {"data": "refund", "bSortable": false},
                    {"data": "created_at"},
                    {"data": "actions", "bSortable": false}
                ],
                ajax: {
                    url: route('admin.packagesellings.datatable'),
