        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_custom_forms', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_custom_forms') )
                },
                ...
                "columns": [
                    ...
                    {"data": "form_type", "bSortable": false},
                ...
                ajax: {
                    ...
                    url: route('admin.custom_forms.datatable'),
