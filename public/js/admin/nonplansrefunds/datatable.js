        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_nonplansrefunds', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_nonplansrefunds') )
                },
                ...
                ajax: {
                    ...
                    url: route('admin.nonplansrefunds.datatable'),
