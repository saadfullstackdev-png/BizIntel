        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_discounts', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_discounts') )
                },
                ...
                "columns": [
                    ...
                    {"data": "discount_type", "bSortable": false},
                    {"data": "start", "bSortable": false},
                    {"data": "end", "bSortable": false},
                    {"data": "slug", "bSortable": false},
                ...
                ajax: {
                    ...
                    url: route('admin.discounts.datatable'),
