        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_locations', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_locations') )
                },
                ...
                "columns": [
                    ...
                    { "data": "fdo_name" ,"bSortable": false},
                    { "data": "fdo_phone" ,"bSortable": false},
