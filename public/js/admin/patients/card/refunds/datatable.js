        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_patient_refunds', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_patient_refunds') )
                },
                ...
                ajax: {
                    ...
                    url: route('admin.refundpatient.datatable',[$('#patient_id').val()]),
