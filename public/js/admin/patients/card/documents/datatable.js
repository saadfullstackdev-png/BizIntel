        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_patient_documents', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_patient_documents') )
                },
                ...
                ajax: {
                    ...
                    url: route('admin.patients.documentdatatable',[$('#patient_id').val()]),
