        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_patient_packages', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_patient_packages') )
                },
                ...
                "columns": [
                    ...
                    { "data": "package_id","bSortable": false },
                    {"data": "location_id", "bSortable": false},
                    { "data": "session_count" ,"bSortable": false},
                    { "data": "total" ,"bSortable": false},
                    { "data": "cash_receive","bSortable": false },
                    {"data": "refund", "bSortable": false},
                    {"data": "package_selling_id", "bSortable": false},
                ...
                ajax: {
                    ...
                    url: route('admin.plans.datatable',[$('#patient_id').val()]),
