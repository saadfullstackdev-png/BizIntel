        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_patient_invoices', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_patient_invoices') )
                },
                ...
                "columns": [
                    ...
                    { "data": "invoice_status","bSortable": false },
                ...
                ajax: {
                    ...
                    url: route('admin.invoicepatient.datatable',[$('#patient_id').val()]),
