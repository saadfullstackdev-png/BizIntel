        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function(settings,data) {
                    localStorage.setItem( 'DataTables_banner', JSON.stringify(data) )
                },
                stateLoadCallback: function(settings) {
                    return JSON.parse( localStorage.getItem( 'DataTables_banner') )
                },
                ...
                "columns": [
                    ...
                    { "data": "banner_type","bSortable": false },
                    { "data": "banner_value","bSortable": false },
