        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                stateSaveCallback: function (settings, data) {
                    localStorage.setItem('DataTables_notification_templates', JSON.stringify(data))
                },
                stateLoadCallback: function (settings) {
                    return JSON.parse(localStorage.getItem('DataTables_notification_templates'))
                },
                ...
                "columns": [
                    ...
                    {"data": "image_url", "bSortable": false},
                    {"data": "status", "bSortable": false},
                    {"data": "actions", "bSortable": false}
                ],
                ajax: {
                    // url: "../demo/table_ajax.php",
                    url: route('admin.notification_templates.datatable'),
