...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('appointment_statuses_create'))
                    <a class="btn btn-success" href="{{ route('admin.appointment_statuses.create') }}" data-target="#ajax_appointmentstatuses" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.appointment_statuses.fields.name')</th>
                        <th>@lang('global.appointment_statuses.fields.parent')</th>
                        <th>@lang('global.appointment_statuses.fields.is_comment')</th>
                        <th>@lang('global.appointment_statuses.fields.allow_message')</th>
                        <th>@lang('global.appointment_statuses.fields.is_default')</th>
                        <th>@lang('global.appointment_statuses.fields.is_arrived')</th>
                        <th>@lang('global.appointment_statuses.fields.is_cancelled')</th>
                        <th>@lang('global.appointment_statuses.fields.is_unscheduled')</th>
                        <th>@lang('global.appointment_statuses.fields.status')</th>
                        <th width="12%">@lang('global.appointment_statuses.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        <td></td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="appointment_status_name" value="{{ $filters->get(Auth::User()->id, 'appointment_statuses', 'appointment_status_name') }}">
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                        ...
                        <td></td>
                        <td></td>
                        <td> {!! Form::select('status', ['0' => 'Inactive','1' => 'Active'] , $filters->get( Auth::user()->id ,'appointment_statuses', 'status') , ['class' => 'form-control form-filter input-sm select2', 'placeholder' => 'All']) !!} </td>
                        <td>
    ...
    <div class="modal fade" id="ajax_appointmentstatuses" role="basic" aria-hidden="true">
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/appointment_statuses/datatable.js') }}" type="text/javascript"></script>
