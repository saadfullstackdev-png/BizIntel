...
@section('title')
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title">Bookings Arrivals & Conversions Report</h1>
<!-- END PAGE TITLE-->
@endsection
@section('content')
...
<div class="portlet light portlet-fit portlet-datatable bordered">
    <div class="portlet-body sn-panel">
        ...
        <div class="form-group col-sm-3 sn-select  @if($errors->has('group_id')) has-error @endif">
            {!! Form::label('load_conversion_report', '&nbsp;', ['class' => 'control-label']) !!}<br />
            <a href="javascript:void(0);" onclick="FormControls.loadconversionReport();" id="load_conversion_report"
