...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.reports.employee_appointment_summary')</h1>
    <!-- END PAGE TITLE-->
@endsection
@section('content')
            ...
            <div class="box box-primary">
                <div class="panel-body pad table-responsive">
                    ...
                    <div class="form-group col-md-3 @if($errors->has('report_type')) has-error @endif">
                        ...
                        {!! Form::select('report_type', array('default' => 'Select a Report Type', 'general' => 'General Report','staff_appointment' => 'Staff Appointment Schedule Report','empolyee_summary' => 'Employee Appointment Summary'), null, ['id' => 'report_type', 'style' => 'width: 100%;', 'class' => 'form-control']) !!}
