                ...
                <table class="table">
                    ...
                    @if(count($reportData))
                        ...
                        <tr style="background-color:#3aaddc;color: #fff;">
                            ...
                            <td></td>
                            <td></td>
                            <td style="color: #fff;font-weight: 600">{{number_format($monthly_target_total,2)}}</td>
                            <td style="color: #fff;font-weight: 600">{{number_format($monthly_achived_total,2)}}</td>
                            <td style="color: #fff;font-weight: 600">{{number_format(($monthly_achived_total/$monthly_target_total)*100,2)}}%</td>
                        </tr>
                    @else
                        @if($message)
                            <tr>
