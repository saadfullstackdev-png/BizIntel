            ...
            <div class="sn-buttons">
                @if( $medium_type == 'web')
                    <a class="btn sn-white-btn btn-default"
                       href="{{ route('admin.dashboadReport.revenuebyservicereport',['excel',$my_collection,$period]) }}" target="_blank">
                        <i class="fa fa-file-excel-o"></i><span>Excel</span>
                    </a>
                    <a class="btn sn-white-btn btn-default"
                       href="{{ route('admin.dashboadReport.revenuebyservicereport',['pdf',$my_collection,$period]) }}" target="_blank">
                        <i class="fa fa-file-pdf-o"></i><span>PDF</span>
                    </a>
                    <a class="btn sn-white-btn btn-default"
                       href="{{ route('admin.dashboadReport.revenuebyservicereport',['print',$my_collection,$period]) }}" target="_blank">
