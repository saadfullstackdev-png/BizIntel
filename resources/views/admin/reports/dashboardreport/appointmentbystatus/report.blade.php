...
@section('content')
    ...
    <div class="sn-table-holder">
        <div class="sn-report-head">
            <div class="sn-title">
                <h1>{{ ($performance === 'true') ? 'My Appointments By Status Report' : 'Appointments By Status Report' }}</h1>
            </div>
            ...
            <div class="sn-buttons">
                @if( $medium_type == 'web')
                    <a class="btn sn-white-btn btn-default"
                       href="{{ route('admin.dashboardreport.appointmentsByStatus',[$period , 'excel', $performance ]) }}" target="_blank">
                        <i class="fa fa-file-excel-o"></i><span>Excel</span>
                    </a>
                    <a class="btn sn-white-btn btn-default"
                       href="{{ route('admin.dashboardreport.appointmentsByStatus',[$period,'pdf', $performance ]) }}"
                       target="_blank">
                        <i class="fa fa-file-pdf-o"></i><span>PDF</span>
                    </a>
                    <a class="btn sn-white-btn btn-default"
                       href="{{ route('admin.dashboardreport.appointmentsByStatus',[$period,'print', $performance ]) }}"
                       target="_blank">
