            ...
            <table class="table">
                ...
                @if(count($reportData))
                    ...
                    <tr style="background: #364150;color: #fff;">
                        ...
                        <td style="color: #fff;font-weight: bold;">{{$grandcount}}</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        ...
                        <td></td>
                        <td></td>
                        <td style="color: #fff; font-weight: bold;text-align: right;"><?php echo number_format($servicegrandtotal,2); ?></td>
                        <td style="color: #fff; font-weight: bold;text-align: right;"><?php echo number_format($salesgrandtotal,2); ?></td>
                        <td></td>
                    </tr>
                @else
                    @if($message)
