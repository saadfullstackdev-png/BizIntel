                ...
                @if(count($reportData))
                    ...
                    @foreach($reportData as $reportlocation)
                        ...
                        <tr style="background-color: #35a1d4; color: #fff;">
                            ...
                            <td></td>
                            <td></td>
                            <td style="font-weight: bold;color: #fff;">{{number_format($machinetotal_in_t,2) }}</td>
                            <td style="font-weight: bold;color: #fff;">{{number_format($machinetotal_out_t,2) }}</td>
                            <td style="font-weight: bold;color: #fff;">{{number_format($machinetotal_in_t-$machinetotal_out_t,2)}}</td>
                        </tr>
                    @endforeach
                    <tr style="background: #364150; color: #fff;">
                        ...
                        <td></td>
                        <td></td>
                        <td style="font-weight: bold;color: #fff;">{{number_format($machinetotal_in_g,2) }}</td>
                        <td style="font-weight: bold;color: #fff;">{{number_format($machinetotal_out_g,2) }}</td>
                        <td style="font-weight: bold;color: #fff;">{{number_format($machinetotal_in_g-$machinetotal_out_g,2)}}</td>
                    </tr>
                @else
                    @if($message)
                        <tr>
