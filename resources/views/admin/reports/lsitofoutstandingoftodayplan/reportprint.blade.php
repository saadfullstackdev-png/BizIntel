    ...
    <table class="table">
        ...
        @if(count($reportData))
            ...
            <tr style="background: #364150; color: #fff;">
                ...
                <td></td>
                <td></td>
                <td style="text-align: right; font-weight:bold;color:#fff;">{{ number_format($gtotal,2) }}</td>
                <td style="text-align: right; font-weight:bold;color:#fff;">{{ number_format($gadvances,2) }}</td>
                <td style="text-align: right; font-weight:bold;color:#fff;">{{ number_format($goutstanding,2) }}</td>
                <td style="text-align: right; font-weight:bold;color:#fff;">{{ number_format($guse,2) }}</td>
                <td style="text-align: right; font-weight:bold;color:#fff;">{{ number_format($gunused,2) }}</td>
            </tr>
        @else
            @if($message)
                <tr>
