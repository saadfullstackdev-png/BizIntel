            ...
            <td style="padding-left: 450px;">
                <table style="float: right;">
                    <tr>
                        ...
                        <td>Summarized Data of Discounts given to the customer Report</td>
                    </tr>
                    <tr>
        ...
        @if(count($reportData))
            ...
            @foreach($reportData as $reportRow)
                <tr>
                    ...
                    <td style="text-align: right;"><?php echo number_format($reportRow['orignal_price'], 2)?></td>
                    <td style="text-align: right;"><?php echo number_format($reportRow['discount_price'], 2) ?></td>
                    <td  style="text-align: right;"><?php echo number_format($reportRow['tax_amt'],2) ?></td>
                    <?php
            ...
            <tr style="background: #364150; color: #fff;">
                ...
                <td></td>
                <td></td>
                <td style="text-align: right; color: #fff;"><?php echo number_format($gorignaltotal, 2);?></td>
                <td style="text-align: right; color: #fff;"><?php echo number_format($gdiscounttotal, 2);?></td>
                <td style="text-align: right; color: #fff;"><?php echo number_format($grandtaxtotal,2);?></td>
            </tr>
        @else
            @if($message)
                <tr>
