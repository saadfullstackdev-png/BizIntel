...
<div class="invoice-pdf">
            ...
            <td style="padding-left: 450px;">
                <table style="float: right;">
                    <tr>
                        ...
                        <td>List Of Outstanding As Of Today For Non Plan Report</td>
                    </tr>
                    <tr>
    ...
    <table class="table">
        ...
        @if(count($reportData))
            ...
            @endforeach
            <tr style="background: #0a6aa1;color: #fff;">
                ...
                <td style="text-align: right;"><?php echo number_format($gadvances,2);?></td>
                <td style="text-align: right;"><?php echo number_format($goutstanding,2);?></td>
                <td style="text-align: right;"><?php echo number_format($guse,2);?></td>
                <td style="text-align: right;"><?php echo number_format($gunused,2);?></td>
            </tr>
        @else
            @if($message)
                <tr>
