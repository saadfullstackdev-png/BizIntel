                    ...
                    @if(count($reportData))
                        ...
                        @foreach($reportData as $reportpackagedata)
                            <tr style="background-color: #dddddd">
                                <td colspan="15"><?php echo $reportpackagedata['name']; ?></td>
                            </tr>
                            ...
                            @foreach($reportpackagedata['records'] as $reportRow )
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($request->get('medium_type') == 'web')
                                            <a target="_blank" href="{{ route('admin.patients.preview',[$reportRow->patient->id]) }}">{{ $reportRow->patient->name }}</a>
                                        @else
                            ...
                            <tr style="background-color:#3aaddc;color: #fff;">
                                <td colspan="3" style="color: #fff;"><?php echo $reportpackagedata['name']; ?></td>
                        ...
                        <tr style=" background: #364150; color: #fff; font-weight: bold">
                            ...
                            <td></td>
                            <td></td>
                            <td style="color: #fff; text-align: right;"><?php echo number_format($servicegrandtotal,2); ?></td>
                            <td style="color: #fff; text-align: right;"><?php echo number_format($salesgrandtotal,2); ?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
