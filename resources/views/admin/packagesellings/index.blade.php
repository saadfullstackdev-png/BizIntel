...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.packagesellings.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
            ...
            <div class="table-container">
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        <th>@lang('global.packagesellings.fields.id')</th>
                        <th>@lang('global.packagesellings.fields.name')</th>
                        <th>@lang('global.packagesellings.fields.patient')</th>
                        <th>@lang('global.packagesellings.fields.total_services')</th>
                        <th>@lang('global.packagesellings.fields.paid_amount')</th>
                        <th>@lang('global.packagesellings.fields.refun')</th>
                        <th>@lang('global.packagesellings.fields.created_at')</th>
                        <th width="20%">@lang('global.packagesellings.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        <td>
                            <input type="text" class="form-control form-filter input-sm"
                                   value="{{ $filters->get(Auth::User()->id, 'packagesellings', 'id') }}" name="id">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm"
                                   value="{{ $filters->get(Auth::User()->id, 'packagesellings', 'name') }}" name="name">
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="total_services"
                                   value="{{$filters->get(Auth::user()->id, 'packagesellings' ,'total_services')}}">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="tax_including_price"
                                   value="{{$filters->get(Auth::user()->id, 'packagesellings', 'tax_including_price')}}">
                        </td>
                        <td></td>
                        <td>
                            <div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
                                <input type="text" class="form-control form-filter input-sm" readonly=""
                                       value="{{ ($filters->get(Auth::User()->id, 'packagesellings', 'created_from')) ? Carbon\Carbon::parse($filters->get(Auth::User()->id, 'packagesellings', 'created_from'))->format('Y-m-d') : '' }}"
                            ...
                            <div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
                                <input type="text" class="form-control form-filter input-sm" readonly=""
                                       name="created_to"
                                       value="{{ ($filters->get(Auth::User()->id, 'packagesellings', 'created_to')) ? Carbon\Carbon::parse($filters->get(Auth::User()->id, 'packagesellings', 'created_to'))->format('Y-m-d') : '' }}"
                                       placeholder="To">
                                <span class="input-group-btn">
                                    <button class="btn btn-sm default" type="button">
                                        <i class="fa fa-calendar"></i>
    ...
    <div class="modal fade" id="ajax_packageselling" role="basic" aria-hidden="true">
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/packagesellings/datatable.js') }}" type="text/javascript"></script>
