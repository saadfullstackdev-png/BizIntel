...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.app_appointmentmeasurement')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
            ...
            <div class="actions">
                @if(Gate::allows('appointments_measurement_create'))
                    <a class="btn btn-success btn-to-focus"
                       href="{{ route('admin.appointmentsmeasurement.create',[$appointment->id]) }}"
                       data-target="#ajax_measurement_addnew" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        <th>@lang('global.appointmentmesurement.fields.name')</th>
                        <th>@lang('global.appointmentmesurement.fields.patient_name')</th>
                        <th>@lang('global.appointmentmesurement.fields.created_by')</th>
                        <th>@lang('global.appointmentmesurement.fields.type')</th>
                        <th>@lang('global.appointmentmesurement.fields.created_at')</th>
                        <th width="20%">@lang('global.appointmentmesurement.fields.actions')</th>
                    </tr>
    ...
    <div class="modal fade" id="ajax_measurement_addnew" role="basic" aria-hidden="true">
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/measurements/datatable.js') }}" type="text/javascript"></script>
