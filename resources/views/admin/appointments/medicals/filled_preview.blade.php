...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.app_appointmentmedicalforms')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a style="margin: 5px;" href="{{ route('admin.appointmentsmedical.medicals',[$medicalinformation->appointment_id]) }}"
