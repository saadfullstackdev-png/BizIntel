...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
        ...
        {!! Form::select('service_id', $services, $appointment->service_id, ['id' => 'service_service_id', 'disabled'=>'disabled', 'class' => 'form-control ']) !!}
    </div>
</div>

<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
        {!! Form::label('service_city_id', 'City*', ['class' => 'control-label']) !!}
        {!! Form::select('city_id', $cities, $appointment->city_id, ['onchange' => 'EditServiceFormValidation.loadLocations($(this).val());', 'id' => 'service_city_id', 'class' => 'form-control ']) !!}
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
        {!! Form::label('service_location_id', 'Location*', ['class' => 'control-label']) !!}
        <div class="service_location_id">
            {!! Form::select('location_id', $locations, $appointment->location_id, ['onchange' => 'EditServiceFormValidation.loadDoctors($(this).val());', 'id' => 'service_location_id', 'class' => 'form-control ']) !!}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
        {!! Form::label('service_doctor_id', 'Doctor*', ['class' => 'control-label']) !!}
        <div class="service_doctor_id">
            {!! Form::select('doctor_id', $doctors, $appointment->doctor_id, ['onchange' => 'EditServiceFormValidation.doctorListener($(this).val());', 'id' => 'service_doctor_id', 'class' => 'form-control ']) !!}
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
        {!! Form::label('service_machine_id', 'Machine*', ['class' => 'control-label']) !!}
        <div class="service_machine_id">
            {!! Form::select('machine_id', $machines, $appointment->resource_id, ['onchange' => 'EditServiceFormValidation.machineListener($(this).val())', 'id' => 'service_machine_id', 'class' => 'form-control']) !!}
        </div>
    </div>
</div>
<div class="row">
...
<input type="hidden" id="machineRotaDayID" value="{{ $machineHadRotaDay->id }}" />
