                ...
                <div>
                                        ...
                                        <div id="location_doctor{{ $location->id }}" class="doctors_outer" style="display: none;">
                                            @foreach($location->doctorsActive as $doctor)
                                                @if(in_array($doctor->location_id, $acl_centres))
                                                    <label>
                                                        <input type="radio" data-doctor_name="{{ $doctor->name }}" name="doctor_id" @if($doctor->id == $appointment->doctor_id) checked="true" @endif id="doctor_id{{ $doctor->id }}" value="{{ $doctor->id }}" class="required doctor_id"/>
                    ...
                    <section class="checkbox-module-step4">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('treatment_id', $treatments, $appointment->treatment_id, ['id' => 'treatment_id', 'class' => 'required']) !!}
                            ...
                            <input id="full_name" name="full_name" type="text" class="required custom-input" value="{{ ($appointment->full_name) ? $appointment->full_name : $appointment->lead->patient->full_name }}" placeholder="Patient Name*">
                        </div>
                        <div class="col-md-12">
