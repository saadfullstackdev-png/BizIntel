    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-sharp">
                ...
                <span class="caption-subject bold uppercase"> @lang('global.app_SortCenters')</span>
            </div>
            <div class="actions">
                ...
                <div class="dd" id="nestable_list_3">
                    <ul id="data" class="dd-list">
                        @foreach($location as $location)
                            <li class="dd-item dd3-item" id="{{$location->id}}">
                                <div class="dd-handle dd3-handle"> </div>
                                <div class="dd3-content"> {{$location->name}} </div>
                            </li>
                        @endforeach
                    </ul>
                </div>
            ...
            $('#data').sortable({
                stop:function(){
                    $.map($(this).find('li'),function(el){
                        ...
                        $.ajax({
                            url: route('admin.locations.sort_save'),
                            type:'get',
                            dataType:'json',
