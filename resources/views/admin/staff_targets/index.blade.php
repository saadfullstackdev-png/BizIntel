...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.staff_targets.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
            ...
            <div class="table-container">
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        <th width="20%">@lang('global.staff_targets.fields.name')</th>
                        <th>@lang('global.staff_targets.fields.city')</th>
                        <th>@lang('global.staff_targets.fields.region')</th>
                        <th width="13%">@lang('global.staff_targets.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="lead_status_name" value="{{ $filters->get(Auth::User()->id, 'staff_target_location', 'lead_status_name') }}">
                        </td>
                        <td>
                            {!! Form::select('lead_status_city', $cities, $filters->get(Auth::User()->id, 'staff_target_location', 'lead_status_city'), ['class' => 'form-control form-filter input-sm select2']) !!}
                        </td>
                        <td>
                            {!! Form::select('region', $regions, $filters->get(Auth::User()->id, 'staff_target_location', 'region'), ['class' => 'form-control form-filter input-sm select2']) !!}
                        </td>
                        <td>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/staff_targets/datatable.js') }}" type="text/javascript"></script>
