...
@section('patient_content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.plans.createplan',[$patient->id])}}" class="btn dark">@lang('global.app_reset')</a>
                <a href="{{ route('admin.plans.index',[$patient->id]) }}" class="btn dark">@lang('global.app_back')</a>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit bordered calendar">
                        ...
                        <!-- Ends Form Validation Messages -->
                            @include('admin.patients.card.plans.create_fields')
                        </div>
                    </div>
                </div>
            </div>
...
@section('javascript')
    <script>
        $(document).ready(function () {
            $("#location_id_1").val($("#location_id_1 option:nth-child(2)").val()).change();
        });
    ...
    <script src="{{ url('js/admin/patients/card/plans/create.js') }}" type="text/javascript"></script>
