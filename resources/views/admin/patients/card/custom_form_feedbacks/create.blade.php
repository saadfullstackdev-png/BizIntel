...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.customformfeedbackspatient.index',[$patient_id]) }}"
        ...
        <div class="portlet-body rs">
            ...
            <form id="cf_form">
                ...
                @include('admin.patients.card.custom_form_feedbacks.fields.select_patient')
                ...
                <div class="margin-top-10">
                    ...
                    <a href="{{ route('admin.customformfeedbackspatient.index',[$patient_id]) }}" class="btn default">Cancel </a>
                </div>
            </form>
                ...
                $(function () {
                    ...
                    $("#cf_form").submit(function(e){
                        ...
                        if($("#cf_form").valid()){
                            ...
                            window.location.href = '{{ route('admin.customformfeedbackspatient.index',[$patient_id]) }}';
