            ...
            <div class="table-container">
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="filter">
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="setting_name" value="{{ $filters->get(Auth::User()->id, 'settings', 'setting_name') }}">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="setting_data" value="{{ $filters->get(Auth::User()->id, 'settings', 'setting_data') }}">
                        </td>
                        <td>
