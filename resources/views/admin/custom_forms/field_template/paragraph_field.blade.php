<div id="' + field_id + '"
     class="form-group mt-repeater update-question-fields cf_field ui-state-default cf_field_paragraph">
    <span class="cf_field_text_type"> Paragraph </span>
    <div class="form-group form-md-line-input">
        <input id="question" name="question" type="text" placeholder="Long Answer Field"
