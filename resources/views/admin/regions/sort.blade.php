    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-green-sharp">
                ...
                <span class="caption-subject bold uppercase"> @lang('global.app_sort_region')</span>
            </div>
            <div class="actions">
                <a href="{{ route('admin.regions.index') }}" class="btn dark pull-right">@lang('global.app_back')</a>
            </div>
        </div>
