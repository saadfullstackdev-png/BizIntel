...
<div class="modal-body">
    <div class="portlet-body form">
        <div class="form-group">
            {!! Form::open(['method' => 'POST', 'id' => 'form-validation', 'route' => ['admin.resources.store']]) !!}
            <div class="form-body">
                <!-- Starts Form Validation Messages -->
            @include('partials.messages')
            <!-- Ends Form Validation Messages -->
                @include('admin.resources.create_fields')
            </div>
            <div>
    ...
    <script src="{{ url('js/admin/resources/create.js') }}" type="text/javascript"></script>
