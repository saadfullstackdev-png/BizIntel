...
<div class="modal-body">
    <div class="portlet-body form">
        <div class="form-group">
            {!! Form::model($user, ['method' => 'PATCH', 'id' => 'form-validation', 'route' => ['admin.doctors.save_password']]) !!}
            <div class="form-body">
                <div class="row">
...
<script src="{{ url('js/admin/doctors/change_password.js') }}" type="text/javascript"></script>
