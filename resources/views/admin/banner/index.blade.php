...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.banners.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('banners_create'))
                    <a class="btn btn-success btn-to-focus" href="{{ route('admin.banner.create') }}" data-target="#ajax_banners" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.banners.fields.image')</th>
                        <th>@lang('global.banners.fields.banner_type')</th>
                        <th>@lang('global.banners.fields.banner_value')</th>
                        <th>@lang('global.banners.fields.status')</th>
                        <th width="20%">@lang('global.banners.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        <td></td>
                        <td></td>
                        <td> <input type="text" class="form-control form-filter input-sm" value="{{ $filters->get(Auth::User()->id, 'banners', 'banner_type') }}" name="banner_type"></td>
                        <td> <input type="text" class="form-control form-filter input-sm" value="{{ $filters->get(Auth::User()->id, 'banners', 'banner_value') }}" name="banner_value"></td>
                        <td> {!! Form::select('status', ['0' => 'Inactive', '1' => 'Active'], $filters->get( Auth::user()->id , 'banners', 'status'), ['class' => 'form-control form-filter input-sm select2', 'placeholder' => 'All']) !!}</td>
                        <td>
    ...
    <div class="modal fade" id="ajax_banners" role="basic" aria-hidden="true">
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/banner/datatable.js') }}" type="text/javascript"></script>
    <script src="{{ url('js/admin/banner/ajaxselectbannertype_id.js') }}" type="text/javascript"></script>
