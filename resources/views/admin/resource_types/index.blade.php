...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.resource_types.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('resource_types_create'))
                    <a class="btn btn-success" href="{{ route('admin.resource_types.create')}}" data-target="#ajax_resource_types_addnew" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.resource_types.fields.name')</th>
                        <th width="20%">@lang('global.resource_types.fields.actions')</th>
                    </tr>
    ...
    <div class="modal fade" id="ajax_resource_types_edit" role="basic" aria-hidden="true">
    ...
    <div class="modal fade" id="ajax_resource_types_addnew" role="basic" aria-hidden="true">
        <div class="modal-content">
            <div class="modal-body">
                <span> &nbsp;&nbsp;Loading... </span>
            </div>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/resource_types/datatable.js') }}" type="text/javascript"></script>
