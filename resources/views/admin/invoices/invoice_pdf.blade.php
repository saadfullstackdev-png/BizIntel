...
<div class="invoice-pdf">
    ...
    <table>
        ...
        <tr>
            <td style="width:200px"><strong>Name:</strong><span style="padding-left: 10px;">{{$patient->name}}</span>
            </td>
            <td><!-- left empty --></td>
            <td><!-- left empty --></td>
            <td><!-- left empty --></td>
...
<table style="width: 100%;">
    <tr>
        <td>
            <div class="danger-alert">Invoice is not Refundable</div>
        </td>
    </tr>
</table>
@if ($appointment_info->appointment_type_id == 1)
    <footer>
        <img src=
             "https://chart.googleapis.com/chart?cht=qr&chl={{$id}}&chs=70x70&chld=L|0"
