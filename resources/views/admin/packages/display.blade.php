<div class="modal-header">
    ...
    <h4 class="modal-title text-center">@lang('global.packages.receipt')</h4>
</div>
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        {!! Form::label('parent_id', 'Customer ID', ['class' => 'control-label']) !!}
                        <span style="font-size:18px;display: block;"><strong>{{$package->user->id}}</strong></span>
                    </div>
                </div>
