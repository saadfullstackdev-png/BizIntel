...
<div class="row">
    <div class="form-group col-md-2">
        ...
        {!! Form::select('location_id_1', $locations, '', ['class' => 'form-control select2','id' => 'location_id_1']) !!}
    </div>
...
<div class="row">
    <div class="form-group col-md-6">
        ...
        <select name="service_id_1" id="service_id_1" class="form-control select2 service_id_1" data-placeholder="Select Service"></select>
    </div>
    <div class="form-group col-md-6">
        ...
        <select name="discount_id_1" id="discount_id_1" class="form-control select2 discount_id_1">
            <option value="0">Select Discounts</option>
        </select>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="form-group col-md-12">
        <button class="btn btn-success" name="AddPackageFinal_1" id="AddPackageFinal_1" style="float: right">
            Save
        </button>
    </div>
</div>
