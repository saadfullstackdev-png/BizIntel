...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{{ route('admin.packages.edit',[$package->id]) }}" class="btn dark">@lang('global.app_reset')</a>
                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit bordered calendar">
                        <div class="portlet-body">
                            ...
                            @include('admin.packages.update_fields')
                        </div>
                    </div>
                </div>
            </div>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/packages/update.js') }}" type="text/javascript"></script>
