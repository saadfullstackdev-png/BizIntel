...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.export_logs.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.export_logs.fields.user_name')</th>
                        <th>@lang('global.export_logs.fields.exported_model')</th>
                        <th>@lang('global.export_logs.fields.created_at')</th>
                        <th>@lang('global.export_logs.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        ...
                        <td>
                            {!! Form::select('exported_model', array('' => 'All', 1 => 'Appointments', 2 => 'Leads'),null, ['class' => 'form-control form-filter input-sm select2']) !!}
                        </td>
                        <td>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/export_logs/datatable.js') }}" type="text/javascript"></script>
