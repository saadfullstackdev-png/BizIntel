...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a style="margin: 5px;" href="{{ route('admin.custom_form_feedbacks.index') }}"
                   class="btn dark pull-right">@lang('global.app_back')
                </a>
                @if(Gate::allows('custom_form_feedbacks_manage'))
                <a target="_blank" style="margin: 5px;" href="{{ route('admin.custom_form_feedbacks.filled_print',$thisId) }}"
                   class="btn dark pull-right">@lang('global.app_print')
                </a>
                @endif
                @if(Gate::allows('custom_form_feedbacks_manage'))
                <a style="margin: 5px;" href="{{ route('admin.custom_form_feedbacks.export_pdf',$thisId) }}"
