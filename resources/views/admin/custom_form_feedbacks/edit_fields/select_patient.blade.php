<div class="form-group form-md-line-input cf_card update_patient_data">
    ...
    <label>
        <select class="form-control cf-input-border select2 patient_id" name="{{\App\Helpers\CustomFormFeedbackHelper::DEFAULT_SELECT_PATIENT_NAME}}" required="required"></select>
    </label>
</div>
</div>