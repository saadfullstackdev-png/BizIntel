...
@section('content')
    ...
    <div class="portlet light portlet-fit portlet-datatable bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a class="btn btn-success" href="{{ route('admin.cancellation_reasons.create') }}" data-target="#ajax_cancellationreason_addnew" data-toggle="modal">@lang('global.app_add_new')</a>
                {{--<a href="{{ route('admin.cancellation_reasons.create') }}" class="btn btn-success">@lang('global.app_add_new')</a>--}}
                <a href="{{ route('admin.cancellation_reasons.sort') }}" class="btn btn-success">@lang('global.app_Sortcancellation_reason')</a>
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.cancellation_reasons.fields.name')</th>
                        <th width="20%">@lang('global.cancellation_reasons.fields.actions')</th>
                    </tr>
    ...
    <div class="modal fade" id="ajax_cancellationreason_edit" role="basic" aria-hidden="true">
    ...
    <div class="modal fade" id="ajax_cancellationreason_addnew" role="basic" aria-hidden="true">
        <div class="modal-content">
            <div class="modal-body">
                <span> &nbsp;&nbsp;Loading... </span>
            </div>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/cancellation_reasons/datatable.js') }}" type="text/javascript"></script>
