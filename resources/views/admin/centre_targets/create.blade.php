...
<div class="modal-body">
    <div class="portlet-body form">
        <div class="form-group">
            {!! Form::open(['method' => 'POST', 'id' => 'form-validation', 'route' => ['admin.centre_targets.store']]) !!}
            <div class="form-body">
                <!-- Starts Form Validation Messages -->
                @include('partials.messages')
                <div class="alert alert-warning display-hide" id="centre_require_field">
                    <button class="close" data-close="alert"></button>
                    Please select all options to continue.
                </div>
                <div class="alert alert-info display-hide" id="centre_edit_perform">
                    <button class="close" data-close="alert"></button>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <select id="year" name="year" class="form-control"
                                onchange="CreateFormValidation.loadActiveLocation();" required>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        {!! Form::select('month', $months, old('month'), ['onchange' => 'CreateFormValidation.loadActiveLocation();', 'class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                        @if($errors->has('month'))
                            <p class="help-block">
                                {{ $errors->first('month') }}
                            </p>
            ...
            <div style="padding-top: 10px;">
                {!! Form::submit(trans('global.app_save'), ['style' => 'display: ;', 'id' => 'save_btn', 'class' => 'btn btn-success']) !!}
            </div>
            {!! Form::close() !!}
        </div>
    </div>
