...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.user_login_logs.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
            ...
            <div class="table-container">
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        <th width="3%">@lang('global.user_login_logs.fields.id')</th>
                        <th>@lang('global.user_login_logs.fields.user_id')</th>
                        <th>@lang('global.user_login_logs.fields.user_email')</th>
                        <th>@lang('global.user_login_logs.fields.user_ip')</th>
                        <th>@lang('global.user_login_logs.fields.location')</th>
                        <th>@lang('global.user_login_logs.fields.machine_name')</th>
                        <th>@lang('global.user_login_logs.fields.browser')</th>
                        <th>@lang('global.user_login_logs.fields.os')</th>
                        <th>@lang('global.user_login_logs.fields.longitude')</th>
                        <th>@lang('global.user_login_logs.fields.latitude')</th>
                        <th>@lang('global.user_login_logs.fields.country')</th>
                        <th>@lang('global.user_login_logs.fields.country_code')</th>
                        <th>@lang('global.user_login_logs.fields.login_time')</th>
                        <th>@lang('global.user_login_logs.fields.logout_time')</th>
                        <th>@lang('global.user_login_logs.fields.created_at')</th>
                        <th>@lang('global.user_login_logs.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        <td></td>
                        <td><input type="text" class="form-control form-filter input-sm" value="{{ $filters->get(Auth::User()->id, 'userLogingLogs', 'name') }}" name="name"></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        ...
                        <td>
                            <div class="input-icon input-icon-sm right margin-bottom-5">
                                ...
                                <input name="created_from" data-date-format="yyyy-mm-dd" type="text" readonly="" class="form-control form-filter input-sm created_from" placeholder="From" value="{{ ($filters->get(Auth::User()->id, 'userLogingLogs', 'created_from')) ? Carbon\Carbon::parse($filters->get(Auth::User()->id, 'userLogingLogs', 'created_from'))->format('Y-m-d') : '' }}">
                            </div>
                            <div class="input-icon input-icon-sm right margin-bottom-5">
                                <i class="fa fa-calendar"></i>
                                <input name="created_to" data-date-format="yyyy-mm-dd" type="text" readonly="" class="form-control form-filter input-sm created_to" placeholder="To" value="{{ ($filters->get(Auth::User()->id, 'userLogingLogs', 'created_to')) ? Carbon\Carbon::parse($filters->get(Auth::User()->id, 'userLogingLogs', 'created_to'))->format('Y-m-d') : '' }}">
                            </div>
                        </td>
                        <td>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/user_login_logs/datatable.js') }}" type="text/javascript"></script>
