...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.invoiceScanLogs.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
            ...
            <div class="table-container">
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        <th>@lang('global.invoiceScanLogs.fields.user_id')</th>
                        <th>@lang('global.invoiceScanLogs.fields.invoice_id')</th>
                        <th>@lang('global.invoiceScanLogs.fields.action')</th>
                        <th>@lang('global.invoiceScanLogs.fields.invoice_found')</th>
                        <th>@lang('global.invoiceScanLogs.fields.created_at')</th>
                    </tr>
                    </thead>
                    <tbody>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/invoice_scan_logs/datatable.js') }}" type="text/javascript"></script>
