...
class EmployeeAppointmentSummaryReportController extends Controller
{
    public function index() {
        return abort(401);
    }
    /**
     * Display a filters for employee summary report.
     *
     * @return \Illuminate\Http\Response
     */
    public function staffsummeryreport()
    {
        ...
        return view('admin.reports.employeesummaryreports.index', compact( 'patients', 'cities', 'doctors', 'locations', 'services', 'appointment_statuses', 'appointment_types', 'users'));
    }
